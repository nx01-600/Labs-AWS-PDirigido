...
\begin{titlepage}
    ...
    {\normalsize Elaborado: 6 de octubre de 2025\par}
\end{titlepage}
...
\vspace{1cm}
\noindent\textbf{Nota:} Todas las URLs fueron verificadas como activas al momento de la elaboración de este laboratorio (octubre 2025). La documentación oficial de AWS se actualiza regularmente; se recomienda consultar las versiones más recientes para obtener información actualizada sobre nuevas funcionalidades y mejores prácticas.
