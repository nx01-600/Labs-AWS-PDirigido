...
\begin{titlepage}
    ...
    {\large\textbf{Total de Preguntas:} 150+\par}
...
\section{Laboratorio 4: Amazon EC2 y Seguridad de Red}
\textit{[15 preguntas sobre Security Groups, NACLs, EC2...]}

\section{Laboratorio 5: Alta Disponibilidad y Multi-AZ}
\textit{[15 preguntas sobre ELB, Auto Scaling, Multi-AZ...]}

\section{Laboratorio 6: VPC Peering}
\textit{[12 preguntas sobre VPC Peering, limitaciones...]}

\section{Laboratorio 7: VPN y Conectividad Híbrida}
\textit{[12 preguntas sobre VPN Gateway, Customer Gateway...]}

\section{Laboratorio 8: AWS Transit Gateway}
\textit{[12 preguntas sobre Transit Gateway, ruteo...]}

\section{Laboratorio 9: Seguridad Avanzada en Redes}
\textit{[15 preguntas sobre Network Firewall, Flow Logs, WAF...]}

\section{Laboratorio 10: Monitoreo y Troubleshooting}
\textit{[12 preguntas sobre CloudWatch, Reachability Analyzer...]}

\section{Laboratorio 11: AWS Direct Connect}
\textit{[10 preguntas sobre Direct Connect, conceptos...]}

\section{Laboratorio 12: Proyecto Integrador Final}
